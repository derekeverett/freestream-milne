...
#define SIGMA 1.0f //the width of the gaussian distribution in (y - eta)
...
#define DTAU 0.1f //free streaming long. proper time step size
#define TAU0 0.1f //initial long. proper time
#define TAU (TAU0 + DTAU) //final matching long. proper time
