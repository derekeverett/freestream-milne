...
3 : read in from file (superMC block format)
*/
#define INITCOND 3
...
#define DIM_RAP 101 //number of grid points in momentum rapidity
...
#define DRAP 0.05f //spacing of grid in momentum rapidity
